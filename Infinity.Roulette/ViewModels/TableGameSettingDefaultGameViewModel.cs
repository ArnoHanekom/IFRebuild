...
// Type: Infinity.Roulette.ViewModels.TableGameSettingDefaultGameViewModel
...
{
  internal class TableGameSettingDefaultGameViewModel : ViewModelBase
  {
    private readonly ITableSettingService _settingService;
    private readonly IGameTypeService _gameTypeService;

    public TableGameSettingDefaultGameViewModel(
